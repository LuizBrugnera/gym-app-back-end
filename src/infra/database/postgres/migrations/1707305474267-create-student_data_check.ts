  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
                ...
                CREATE TABLE "student_data_check" (
                    ...
                    CONSTRAINT "FK_student_data_check_studentId" FOREIGN KEY ("studentId") REFERENCES "student"("id") ON DELETE CASCADE
                );
                CREATE INDEX "idx_student_data_check_student_id" ON "student_data_check" ("studentId");
            `);
  }
